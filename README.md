...
In the server, assigning each user a separate task but then using an entirely different collection of threads to actually process the packets, makes it fairly obvious this is my first ever attempt at any kind of multithreaded relay server.
